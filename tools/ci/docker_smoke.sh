...
# Substitute: board-gauntlet, coworld-board-gauntlet, 2.
#
...
#
# env:
#   SMOKE_IMAGE                image, if not given as $1        (coworld-board-gauntlet:ci)
#   SMOKE_SLUG                 game slug                        (board-gauntlet)
#   SMOKE_GAME_BIN             game entrypoint                  (/bin/board-gauntlet)
#   SMOKE_PLAYER_BIN           player entrypoint                (/bin/board-gauntlet-player)
...
image="${1:-${SMOKE_IMAGE:-coworld-board-gauntlet:ci}}"
slug="${SMOKE_SLUG:-board-gauntlet}"
