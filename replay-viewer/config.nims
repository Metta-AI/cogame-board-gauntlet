...
switch(
  "passL",
  (&"""
  -o {distDir / "gauntlet_replay.js"}
  -O2
  -s ALLOW_MEMORY_GROWTH
  -s ABORTING_MALLOC=1
  -s ENVIRONMENT=web
  -s MODULARIZE=1
  -s EXPORT_NAME=GauntletReplayModule
  -s EXPORTED_RUNTIME_METHODS=HEAPU8
  -s EXPORTED_FUNCTIONS=_main,_malloc,_free,_bg_load_replay,_bg_payload_ptr,_bg_payload_len,_bg_error_ptr,_bg_error_len
  """).replace("\n", " ")
)
